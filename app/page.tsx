...
function useStreak() {
  ...
  const recordWin = useCallback(() => {
    ...
    localStorage.setItem('bb_wins', String(newWins));
  }, [streak, totalWins]);

  const recordLoss = useCallback(() => {
    const newLosses = totalLosses + 1;
    setStreak(0);
    setTotalLosses(newLosses);
    localStorage.setItem('bb_streak', '0');
    localStorage.setItem('bb_losses', String(newLosses));
  }, [totalLosses]);
  ...
  return (
    <div style={{ flex: 1 }}>
      ...
      <div style={{
        ...
        <div style={{
          background: barColor, width: `${pct}%`, height: '100%', borderRadius: 4,
          transition: 'width 0.4s ease',
          animation: danger ? 'dangerPulse 0.8s ease infinite' : 'none',
        }} />
      </div>
    </div>
  );
...
const DamageNumber = ({ value, isPlayer, type }: { value: number; isPlayer: boolean; type: 'hit' | 'block' }) => (
  <div style={{
    ...
    color: type === 'block' ? colors.primary : colors.error,
...
const globalStyles = `
  ...
  @keyframes arenaPattern { 0%{background-position:0 0} 100%{background-position:40px 40px} }
`;
    ...
    <div style={{ background: colors.background, minHeight: '100vh', color: colors.onSurface, fontFamily: 'Inter, sans-serif' }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 480 }}>
          ...
          <h1 style={{
            fontSize: isMobile ? 36 : 58, fontWeight: 900,
            lineHeight: 1.05, letterSpacing: '-0.03em', margin: '0 0 8px',
          }}>
            1v1 Combat.
          </h1>
          <h1 style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ fontSize: 13, fontWeight: 700, color: colors.onSurface }}>
                  {streak > 0 ? `${streak} win streak` : 'Streak broken'}
                </span>
              </div>
              <div style={{
                background: colors.surfaceContainer, border: `1px solid ${colors.outlineVariant}`,
          ...
          <div style={{
            ...
            fontSize: 13, color: colors.onSurfaceVariant, fontStyle: 'italic',
          }}>
        ...
        <div style={{
          ...
          background: `linear-gradient(135deg, ${colors.surfaceContainer}, ${colors.surfaceContainerHigh})`,
          border: `1px solid ${colors.outlineVariant}`,
          borderRadius: 16, padding: isMobile ? '24px 20px' : '32px 48px', flexShrink: 0,
        }}>
...
function BattleScreen({ setPage }: { setPage: (p: Page) => void }) {
  ...
  const act = async (type: 'attack' | 'defend' | 'special') => {
    ...
    if (botDead || playerDead || isLastRound) {
      ...
      if (won) { sound.playVictory(); recordWin(); }
      else { sound.playDefeat(); recordLoss(); }
      setResolving(false);
  ...
  const MoveButtons = ({ compact = false }: { compact?: boolean }) => (
    <div style={{ display: 'grid', gridTemplateColumns: compact ? '1fr' : 'repeat(3, 1fr)', gap: compact ? 4 : 8 }}>
      {([
        ...
        <button key={m.type} onClick={() => act(m.type)} disabled={resolving || over}
          style={{
            background: m.bg, color: '#fff', border: 'none', borderRadius: 8,
            ...
            textAlign: 'left' as const, transition: 'opacity 0.2s', width: '100%',
          }}>
  ...
  const RoundIntro = () => roundIntro ? (
    <div style={{
      ...
      <div style={{
        fontSize: isMobile ? 28 : 40, fontWeight: 900, color: colors.primary,
        letterSpacing: '0.1em', animation: 'roundFlash 0.9s ease forwards',
        textShadow: '0 2px 8px rgba(53,37,205,0.3)',
      }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ color: colors.onSurfaceVariant, marginBottom: 24, fontSize: 14, lineHeight: 1.6 }}>
            {won
              ? `CIPHER-X has been defeated. Your victory is now permanent on BOT Chain. The chain does not forget.`
              : `CIPHER-X remains undefeated. The chain recorded your attempt. Come back stronger.`}
          </p>

          <div style={{
            background: colors.surfaceContainerLow, borderRadius: 10,
            padding: 16, marginBottom: 20, display: 'flex', justifyContent: 'space-around',
          }}>
            {[
  ...
  const arenaBackground = `
    linear-gradient(180deg, ${colors.surfaceContainerLow} 0%, ${colors.background} 100%),
    repeating-linear-gradient(0deg, transparent, transparent 39px, ${colors.outlineVariant}33 39px, ${colors.outlineVariant}33 40px),
    repeating-linear-gradient(90deg, transparent, transparent 39px, ${colors.outlineVariant}33 39px, ${colors.outlineVariant}33 40px)
  `;
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          background: colors.surfaceContainerLow, borderBottom: `1px solid ${colors.outlineVariant}`, flexShrink: 0,
        }}>
          <HPBar hp={playerHP} label="YOU" />
          <div style={{
            background: colors.primaryContainer, color: '#fff',
            padding: '3px 12px', borderRadius: 20, fontWeight: 800, fontSize: 12, whiteSpace: 'nowrap', flexShrink: 0,
          }}>R{round}/10</div>
        ...
        <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
          <div onTouchStart={onTouchStart} onTouchEnd={onTouchEnd} style={{
            ...
            padding: '8px 16px', background: arenaBackground,
            ...
            <div style={{ textAlign: 'center' }}>
              {showTaunt
                ? <div style={{ fontSize: 11, color: colors.tertiaryContainer, fontWeight: 700, maxWidth: 80, fontStyle: 'italic' }}>"{taunt}"</div>
                : lastLine
          ...
          <div style={{
            ...
            <div style={{
              ...
              flex: 1, overflow: 'hidden', fontFamily: 'monospace',
            }}>
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            background: colors.primaryContainer, color: '#fff',
            padding: '4px 12px', borderRadius: 20, fontWeight: 800, fontSize: 12, whiteSpace: 'nowrap', flexShrink: 0,
          }}>R{round}/10</div>
          <HPBar hp={botHP} label="CIPHER-X" flipped />
        </div>
        ...
        <div onTouchStart={onTouchStart} onTouchEnd={onTouchEnd} style={{
          flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'space-around',
          padding: '20px 16px', background: arenaBackground,
          ...
          <div style={{ textAlign: 'center' }}>
            {showTaunt
              ? <div style={{ fontSize: 12, color: colors.tertiaryContainer, fontWeight: 700, maxWidth: 80, fontStyle: 'italic' }}>"{taunt}"</div>
              : lastLine
          ...
          {swipeHint && (
            <div style={{
              ...
              background: 'rgba(0,0,0,0.05)', borderRadius: 20, padding: '6px 16px',
              fontSize: 11, color: colors.onSurfaceVariant, fontWeight: 600, whiteSpace: 'nowrap',
            }}>
        ...
        <div style={{
          ...
          borderTop: `1px solid ${colors.outlineVariant}`, flexShrink: 0, overflow: 'hidden',
        }}>
          <MoveButtons />
        </div>
      </div>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          background: colors.primaryContainer, color: '#fff',
          padding: '6px 20px', borderRadius: 20, fontWeight: 800, fontSize: 14, whiteSpace: 'nowrap', flexShrink: 0,
        }}>ROUND {round} / 10</div>
        <HPBar hp={botHP} label="CIPHER-X" flipped />
      ...
      <div style={{
        flex: 1, display: 'grid', gridTemplateColumns: '1fr 260px 1fr',
        overflow: 'hidden', position: 'relative',
      }}>
        {/* Player */}
        <div style={{
          display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end',
          padding: '24px 24px 32px', borderRight: `1px solid ${colors.outlineVariant}`,
          background: arenaBackground, position: 'relative',
        }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            fontFamily: 'monospace', fontSize: 12, overflowY: 'auto', maxHeight: 260,
          }}>
            {log.slice(-6).map((l, i) => (
              <div key={i} style={{
                padding: '4px 0', borderBottom: `1px solid ${colors.outlineVariant}`,
          ...
          {showTaunt && (
            <div style={{
              ...
              background: colors.surfaceContainerLow, borderRadius: 8,
              border: `1px solid ${colors.outlineVariant}`,
              fontSize: 13, color: colors.tertiaryContainer,
        ...
        <div style={{
          display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end',
          padding: '24px 24px 32px', background: arenaBackground, position: 'relative',
        }}>
      ...
      <div style={{
        ...
        background: colors.surfaceContainerLow, borderTop: `1px solid ${colors.outlineVariant}`,
      }}>
        <MoveButtons />
      </div>
    </div>
  ...
  return (
    <div style={{ background: colors.background, minHeight: '100vh', color: colors.onSurface, fontFamily: 'Inter, sans-serif' }}>
      <header style={{
        display: 'flex', justifyContent: 'space-between', alignItems: 'center',
        padding: isMobile ? '16px 20px' : '20px 48px',
        borderBottom: `1px solid ${colors.outlineVariant}`, background: colors.surfaceContainerLow,
      }}>
